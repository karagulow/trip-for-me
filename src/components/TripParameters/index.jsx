  ...
  return (
    <div className={styles.trip_parameters}>
      <div className={styles.trip_parametersBlock}>
        ...
        <h1 className={styles.trip_parametersBlock__title}>
          Параметры поездки №2
        </h1>
        <div className={styles.trip_parametersBlock__input_col}>
          <input type="text" placeholder="Дата поездки" />
          <input type="text" placeholder="Количество мест" />
        </div>
        <h3 className={styles.trip_parametersBlock__h3}>Стоимость поездки</h3>
        <div className={styles.trip_parametersBlock__input_row}>
          <input type="text" placeholder="Взрослый" />
          <input type="text" placeholder="Детский" />
        </div>
        <h3 className={styles.trip_parametersBlock__h3}>Скидки</h3>
        <div className={styles.trip_parametersBlock__input_row}>
          <input type="text" placeholder="Даты скидки" />
          <input type="text" placeholder="Размер скидки (%)" />
        </div>
        <p className={styles.trip_parametersBlock__text}>
          Объясните причину скидки, например, скидка действует, если человек
          забронировал тур за неделю до его проведения
        </p>
        <button className={styles.trip_parametersBlock__btn}>Сохранить</button>
      </div>
    </div>
  );
};
